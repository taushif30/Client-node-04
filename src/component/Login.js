...
const Login = () => {
    ...
    async function registerUser(e) {
        e.preventDefault()
        await axios.post("https://server-node-04.onrender.com/login", User)
            .then((res) => {
        ...
        <div>
            <div className='loginParent'>
                <form className='loginForm'>
                    ...
                    <br /><button type='button' onClick={registerUser}>Login</button>

                </form>
                <button type='button' style={{ margin: "10px" }} onClick={() => nav("/register")}>Register</button>
